...
export default function HomePage() {
  ...
  return (
    <div style={{ background: bgMain, color: textMain, fontFamily: "'Inter', system-ui, sans-serif", minHeight: '100vh' }}>
      ...
      {/* ── Announcement Bar ─────────────────────────── */}
      <div style={{ background: 'linear-gradient(90deg, #1d4ed8, #0891b2)', padding: '8px 16px', textAlign: 'center', fontSize: '13px', color: 'white' }}>
        <span style={{ opacity: 0.9 }}>✅ Updated 2026 Tax Rates &nbsp;·&nbsp; 🇺🇸 USA &amp; 🇬🇧 UK Calculators &nbsp;·&nbsp; ⚡ Free &amp; Instant Results</span>
      </div>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }} className="flex md:hidden">
            ...
            <button onClick={() => setMobileOpen(v => !v)}
              style={{ width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.05)', color: 'white' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', padding: '80px 20px 60px' }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', position: 'relative' }}>
          ...
          <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}
            style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: '900', lineHeight: 1.1, letterSpacing: '-0.03em', margin: '0 0 20px', color: theme === 'dark' ? 'white' : '#0f172a' }}>
      ...
      <section style={{ padding: '0 20px 60px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <motion.div initial={{ opacity: 0, y: 32 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
            style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.12), rgba(6,182,212,0.08))', border: '1px solid rgba(59,130,246,0.25)', borderRadius: '24px', padding: '32px', backdropFilter: 'blur(16px)' }}>
      ...
      <section style={{ padding: '0 20px 48px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', background: theme === 'dark' ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.04)', border: `1px dashed ${cardBorder}`, borderRadius: '12px', height: '90px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', color: theme === 'dark' ? 'rgba(255,255,255,0.2)' : '#94a3b8' }}>
      ...
      {/* ── Ad Slot 2 ─────────────────────────────────── */}
      <section style={{ padding: '0 20px 64px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', background: theme === 'dark' ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.04)', border: `1px dashed ${cardBorder}`, borderRadius: '12px', height: '90px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', color: theme === 'dark' ? 'rgba(255,255,255,0.2)' : '#94a3b8' }}>
          Advertisement · 728×90
        </div>
      </section>
            ...
            {BLOGS.map((post, i) => (
              <motion.div key={post.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}>
                <Link href={post.href} style={{ display: 'block', textDecoration: 'none', background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: '14px', overflow: 'hidden', transition: 'transform 0.2s' }}
                  ...
                  <div style={{ height: '6px', background: `linear-gradient(90deg, ${post.color.replace('bg-','').replace('500','')}, transparent)`, background: post.color === 'bg-blue-500' ? 'linear-gradient(90deg,#3b82f6,#06b6d4)' : post.color === 'bg-emerald-500' ? 'linear-gradient(90deg,#10b981,#06b6d4)' : post.color === 'bg-violet-500' ? 'linear-gradient(90deg,#8b5cf6,#3b82f6)' : 'linear-gradient(90deg,#f59e0b,#ef4444)' }} />
      ...
      {/* ── Newsletter ───────────────────────────────── */}
      <section style={{ padding: '0 20px 64px' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', background: 'linear-gradient(135deg, rgba(59,130,246,0.12), rgba(6,182,212,0.08))', border: '1px solid rgba(59,130,246,0.2)', borderRadius: '20px', padding: '40px 32px', textAlign: 'center' }}>
      ...
      {/* ── Footer ───────────────────────────────────── */}
      <footer style={{ background: '#020b14', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '48px 20px 32px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
